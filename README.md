...
* **Sınav Formatı:** 90 dakikalık, en fazla 90 soruluk interaktif (PBQ) ve çoktan seçmeli test. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
...
* **Sınav Formatı:** **24 saatlik pratik sınav.** Belirtilen makineler ele geçirilip 24 saat içinde raporlanmalıdır. *(Sadece Online Gözetmenli)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** **48 saatlik pratik sınav.** *(Sadece Online Gözetmenli)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** 4 saatlik adaptif uzlaşma (CAT) sisteminde maksimum 175 soru. *(Sadece yetkili Pearson VUE Test Merkezlerinde Yüz Yüze)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** 4 saat, 150 çoktan seçmeli senaryo sorusu. *(Online Gözetmenli (PSI) veya Test Merkezi)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** 4 saatlik uygulamalı sınav; iki web uygulamasının yetkilerini kırmak hedeflenir. *(Sadece Online Gözetmenli - Examity)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** Proje tabanlı model dağıtım senaryoları. *(Online)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** Çoktan seçmeli sistem analizi ve donanım senaryosu soruları. *(Online Gözetmenli veya Test Merkezi)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** Makine öğrenimi algoritmaları optimizasyonlarına dayalı 180 dakikalık senaryo sınavı. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** Komut sonuçlarını veya parametrelerini ölçen uygulamalı yapılandırma soruları. *(Online Gözetmenli veya Test Merkezi)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** 2 saatlik vaka analizleri ve senaryo mimarisi. *(Online Gözetmenli veya Test Merkezi (Kryterion))*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** 120 dakika, performans ve "troubleshooting" temalı 60 analiz sorusu. *(Online Gözetmenli (Webassessor))*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** 120 dakikalık interaktif vaka analizi soruları. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** 115 dakika, 100 soru. *(Online Gözetmenli veya Test Merkezi)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** İnteraktif ve senaryo temelli (PBQ) 90 çoktan seçmeli soru. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** 120 dakikalık CLI simülasyonları ve çoktan seçmeli sorular. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** İki aşamalı (Core + Concentration sınavı) ağırlıklı laboratuvar sınavları bütünü. *(Online Gözetmenli veya Test Merkezi)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** 80 dakikalık altyapı kurgusu sınavı. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
  - **Pratik Ekosistemi:** EVE-NG ortamına kurulan VM-Series (Palo Alto Firewall) üzerinden trafik loglamaları, SSL dekripsiyon ve Policy yapılandırmaları pratiğe dökülmelidir.
...
* **Sınav Formatı:** TMOS (Traffic Management OS) GUI ve CLI bazlı mimari test. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** 90 dakikalık kod parçası okuma (IDE imkanı olmaksızın derleyici hatası arama) soruları. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Nedir:** Serverless (AWS Lambda, API Gateway) ve asenkron veri erişimi (DynamoDB) servisleriyle uygulama tasarlamayı test eder.
* **Kime Hitap Eder:** Bulut tabanlı yazılım geliştiren Backend ekipleri.
* **Sınav Formatı:** 130 dakikalık uygulama mimarisi odaklı API / Kod çoktan seçmeli testi. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
  - **Pratik Ekosistemi:** AWS üzerinde Python Boto3 (veya JavaScript/Java AWS SDK) uçları kullanarak S3 ve DynamoDB üzerinde operasyonlar yazılmalı ve AWS CLI etkin şekilde kullanılmalıdır.

### 3. TOGAF 9 Certified (The Open Group Architecture Framework)
Kurumsal düzey organizasyonların mimari dönüşümünü haritalandıran global IT Mimarlık sertifikasıdır.
* **Nedir:** Organizasyonları hizalamaya yarayan bir "mimari döngü (Architecture Development Method - ADM)" metodolojisini sorgular.
* **Kime Hitap Eder:** Kurumsal Mimarlar (Enterprise Architects), CTO adayları.
* **Sınav Formatı:** Part 1 (Foundation) ve Part 2 (Certified) olan karma çoktan seçmeli/senaryo sınavları. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
  - **Pratik Ekosistemi:** UML diyagramları, paydaş yönetim senaryoları ve stratejik iş planı analiz şablonları okumaları yapılır. The Open Group resmi dokümanları referanstır.
...
* **Sınav Formatı:** Çok zorlayıcı, uzun paragraflarla ve senaryolarla dolu 180 dakikalık sınav. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Sınav Formatı:** Terminal üzerinden uygulanan iki saatlik pratik sınav. *(Sadece Linux Foundation Portalından Online Gözetmenli)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Nedir:** Uygulama sağlık kontrollerini (Liveness/Readiness Probes), Secrets / ConfigMaps gibi bileşenleri ölçer.
* **Kime Hitap Eder:** DevOps Ekipleri, Backend Yazılımcılar.
* **Sınav Formatı:** 2 Saatlik komut satırı (terminal) pratiği. *(Sadece Linux Foundation Portalından Online Gözetmenli)*
* **Kapsamlı Hazırlık Yöntemi:**
  - **Pratik Ekosistemi:** KodeKloud eğitim ortamları üzerinden Kubernetes dokümantasyonlarından arama yaparak yaml düzenlemeleri konusunda süreyi optimize etmek ana hedeftir.
...
* **Nedir:** RHEL ortamı üzerinde depolama (LVM), kullanıcı izni (ACL), ağ yönetimi ve dosya sistemi konfigürasyonu yapabilmeyi ölçer.
* **Kime Hitap Eder:** Sistem yöneticileri ve DevOps ekipleri.
* **Sınav Formatı:** İnternetsiz, tamamıyla uygulamalı süren ~3 saatlik terminal sınavıdır. *(Test Merkezi veya Uzaktan Kiosk Kurulumu ile Online)*
* **Kapsamlı Hazırlık Yöntemi:**
...
* **Nedir:** CodePipeline entegrasyonu, yüksek trafik ölçekleme grupları ve CloudFormation betik formatlarını denetler.
* **Kime Hitap Eder:** Kıdemli SRE mimarları, Cloud otomasyon uzmanları.
* **Sınav Formatı:** Mimarının otomatikleşmesine dayalı vaka analizlerin sorulduğu üst düzey bir senaryo testidir. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
  - **Pratik Ekosistemi:** Örnek bir mimariyi S3 ve CloudFront'a GitHub bağlantılı (CodeBuild/CodePipeline devrede) bir otomasyon scripti ile yayınlamak sınav felsefesini özetler.
...
* **Nedir:** Azure DevOps, Boards, Repos, Pipelines ve ArgoCD/GitOps standartlarının yönetimine odaklanır.
* **Kime Hitap Eder:** Azure odaklı ekiplerde kıdemli DevOps mimarları.
* **Sınav Formatı:** Azure portalı simulasyonunu da kapsayabilen 120 dakikalık karmaşık CI/CD analizleri. *(Online Gözetmenli veya Test Merkezi (Pearson VUE))*
* **Kapsamlı Hazırlık Yöntemi:**
